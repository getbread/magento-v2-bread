require(
    ...
    function ($, alert) {
        var apiMode = $("#payment_ca_breadcheckout_api_mode").val(),
            apiVersion = $("#payment_ca_breadcheckout_api_version").val(),    
            tenant = $("#payment_ca_breadcheckout_tenant").val(),
            prodKey = "#payment_ca_breadcheckout_api_public_key",
            prodSecret = "#payment_ca_breadcheckout_api_secret_key",
            sandKey = "#payment_ca_breadcheckout_api_sandbox_public_key",
            sandSecret = "#payment_ca_breadcheckout_api_sandbox_secret_key",
